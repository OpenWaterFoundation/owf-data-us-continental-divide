...
WriteGeoLayerToGeoJSON(GeoLayerID="ContinentalDivideMtLayer",OutputFile="../data/continental-divide-mt.geojson",OutputPrecision="6")
#
# ====================================================
# Clip to Idaho
# - use a simple WKT geometry for the clip
...
WriteGeoLayerToGeoJSON(GeoLayerID="ContinentalDivideIdLayer",OutputFile="../data/continental-divide-id.geojson",OutputPrecision="6")
#
# ====================================================
# Clip to Wyoming
# - use a simple WKT geometry for the clip
...
WriteGeoLayerToGeoJSON(GeoLayerID="ContinentalDivideWyLayer",OutputFile="../data/continental-divide-wy.geojson",OutputPrecision="6")
#
# ====================================================
# Clip to Colorado
# - use a simple WKT geometry for the clip
...
WriteGeoLayerToGeoJSON(GeoLayerID="ContinentalDivideCoLayer",OutputFile="../data/continental-divide-co.geojson",OutputPrecision="6")
#
# ====================================================
# Clip to New Mexico
# - use a simple WKT geometry for the clip
...
WriteGeoLayerToGeoJSON(GeoLayerID="ContinentalDivideNmLayer",OutputFile="../data/continental-divide-nm.geojson",OutputPrecision="6")
